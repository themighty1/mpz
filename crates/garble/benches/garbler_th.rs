//! Isolated three-halves garbler benchmarks.
//!
//! Records protocol messages for replay-based isolated benchmarking of three-halves garbler.
//!
//! Run with: cargo bench -p mpz-garble --bench garbler_th
