...
enum ErrorRepr {
    #[error("core error: {0}")]
    Core(#[from] mpz_garble_core::three_halves::EvaluatorError),
    #[error("io error: {0}")]
...
impl From<mpz_garble_core::three_halves::EvaluatorError> for EvaluatorError {
    fn from(err: mpz_garble_core::three_halves::EvaluatorError) -> Self {
