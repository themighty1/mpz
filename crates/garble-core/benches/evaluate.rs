...
use mpz_garble_core::{GarbledCircuit, Key, evaluate_garbled_circuits, half_gates};
...
fn bench_evaluate(c: &mut Criterion) {
    ...
    for &(threshold, name) in THRESHOLDS {
        ...
        // Note: EncryptedGateBatch doesn't implement Clone, so we regenerate per iteration
